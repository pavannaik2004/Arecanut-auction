...
const AllFarmers = () => {
  ...
  const fetchFarmers = async () => {
    try {
      setLoading(true);
      const res = await axios.get(API_ENDPOINTS.allFarmers);
      setFarmers(res.data);
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-heading font-bold text-primary">All Farmers</h1>
        <div className="text-lg font-semibold text-gray-600">Total: {farmers.length}</div>
      </div>
